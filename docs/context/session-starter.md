...
**Approach A roadmap (approved):** M8–M11 shipped through 1.3.x. **M12–M14** (installer trust helpers, Operate polish, Commission inventory export) ship in **1.4.0**. Unit programming remains out of scope.
