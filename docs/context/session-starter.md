...
**Approach A roadmap (approved):** M8 Commission UI → M9 tag DB authoring → M10 diagnostics → **M11** distribution (signing, notarization, auto-update, Linux AppImage) — all shipped through 1.3.x. Unit programming remains out of scope.
